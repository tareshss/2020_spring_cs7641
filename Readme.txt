...
5. run python learning_curves.py to generate learning curves in learning_curves folder.

6. run grid_search.py to generate grid search graphs in grid_search folder along with best fit learning curves
...
8.  Major Libraries SciKit-Learn, MatplotLib, Pandas and Numpy and Anaconda as package manager.
