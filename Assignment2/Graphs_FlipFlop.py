...
def graph_GA():
    df = pd.read_csv("./output/FlipFlop_GA/ga__FlipFlop_GA__run_stats_df.csv")
    ...
    plt.savefig('./graphs/' + 'FlipFlop_GA' + '_' + str(timestr) + '.png')
    plt.close()


def graph_MIMIC():
    df = pd.read_csv("./output/FlipFlop_MIMIC/mimic__FlipFlop_MIMIC__run_stats_df.csv")
    ...
    ax.set_xlabel("Iteration")
    ax.set_ylabel("Best Fitness")
    title = f"Flip Flop MIMIC"
    plt.title(title, fontsize=14, y=1.03)
    timestr = time.strftime("%Y%m%d-%H%M%S")
    plt.savefig('./graphs/' + 'FlipFlop_MIMMIC' + '_' + str(timestr) + '.png')
    plt.close()


def graph_SA():
    df = pd.read_csv("./output/FlipFlop_SA/sa__FlipFlop_SA__run_stats_df.csv")
    ...
    ax.set_ylabel("Best Fitness")
    timestr = time.strftime("%Y%m%d-%H%M%S")
    title = f"FlipFlop for SA"
    plt.title(title, fontsize=14, y=1.03)
    plt.savefig('./graphs/' + 'FlipFlop_SA' + '_' + str(timestr) + '.png')
    plt.close()


def graph_RHC():
    df = pd.read_csv("./output/FlipFlop_RHC/rhc__FlipFlop_RHC__run_stats_df.csv")
    ...
    ax.set_ylabel("Best Fitness")
    timestr = time.strftime("%Y%m%d-%H%M%S")
    title = f"FlipFlip for RHC"
    plt.title(title, fontsize=14, y=1.03)
    plt.savefig('./graphs/' + 'FlipFlop_RHC' + '_' + str(timestr) + '.png')
    plt.close()


def graph_timings():
    df_1 = pd.read_csv("./output/FlipFlop_GA/ga__FlipFlop_GA__run_stats_df.csv")
    df_2 = pd.read_csv("./output/FlipFlop_MIMIC/mimic__FlipFlop_MIMIC__run_stats_df.csv")
    df_3 = pd.read_csv("./output/FlipFlop_SA/sa__FlipFlop_SA__run_stats_df.csv")
    df_4 = pd.read_csv("./output/FlipFlop_RHC/rhc__FlipFlop_RHC__run_stats_df.csv")
    ...
    timestr = time.strftime("%Y%m%d-%H%M%S")
    title = f"FlipFlop Timings for All 4 Algorithms"
    plt.title(title, fontsize=14, y=1.03)
    plt.savefig('./graphs/' + 'FlipFlop_Timings' + '_' + str(timestr) + '.png')
    plt.close()
